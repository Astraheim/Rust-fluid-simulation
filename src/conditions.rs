...
pub const WINDOW_HEIGHT: usize = if ADAPT_TO_WINDOW == true {
    (N as usize + 2) * DY as usize
} else {
    720
}; // Height of the window
pub const WINDOW_WIDTH: usize = if ADAPT_TO_WINDOW == true {
    (N as usize + 2) * DX as usize
} else {
    720
}; // Width of the window
